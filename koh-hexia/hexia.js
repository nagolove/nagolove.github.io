...
(() => {
  ...
  function loadPackage(metadata) {
    ...
    function runWithFS(Module) {
      ...
      Module["FS_createPath"]("/assets", "overlay", true, true);
      Module["FS_createPath"]("/assets", "trees_new", true, true);
...
// end include: /tmp/tmp65dlbf78.js
// include: /tmp/tmpngm81y70.js
...
// end include: /tmp/tmpngm81y70.js
// include: /tmp/tmpja0nf_ir.js
...
// end include: /tmp/tmpja0nf_ir.js
...
function __setitimer_js(which, timeout_ms) {
  if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(20, 0, 1, which, timeout_ms);
...
function _emscripten_get_gamepad_status(index, gamepadState) {
  if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(22, 0, 1, index, gamepadState);
...
function _emscripten_set_window_title(title) {
  if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(40, 0, 1, title);
...
var proxiedFunctionTable = [ _proc_exit, exitOnMainThread, pthreadCreateProxied, ___syscall_dup, ___syscall_dup3, ___syscall_faccessat, ___syscall_fcntl64, ___syscall_fstat64, ___syscall_getcwd, ___syscall_getdents64, ___syscall_ioctl, ___syscall_lstat64, ___syscall_mkdirat, ___syscall_newfstatat, ___syscall_openat, ___syscall_readlinkat, ___syscall_renameat, ___syscall_rmdir, ___syscall_stat64, ___syscall_unlinkat, __setitimer_js, _emscripten_get_element_css_size, _emscripten_get_gamepad_status, _emscripten_get_num_gamepads, _emscripten_sample_gamepad_data, _emscripten_set_blur_callback_on_thread, setCanvasElementSizeMainThread, _emscripten_set_click_callback_on_thread, _emscripten_set_focus_callback_on_thread, _emscripten_set_fullscreenchange_callback_on_thread, _emscripten_set_gamepadconnected_callback_on_thread, _emscripten_set_gamepaddisconnected_callback_on_thread, _emscripten_set_mousemove_callback_on_thread, _emscripten_set_pointerlockchange_callback_on_thread, _emscripten_set_resize_callback_on_thread, _emscripten_set_touchcancel_callback_on_thread, _emscripten_set_touchend_callback_on_thread, _emscripten_set_touchmove_callback_on_thread, _emscripten_set_touchstart_callback_on_thread, _emscripten_set_visibilitychange_callback_on_thread, _emscripten_set_window_title, _environ_get, _environ_sizes_get, _fd_close, _fd_fdstat_get, _fd_read, _fd_seek, _fd_sync, _fd_write ];
...
var ASM_CONSTS = {
  ...
  1742089: () => Module.canvas.width,
  1742121: () => parseInt(Module.canvas.style.width),
  1742169: () => {
  ...
  1742314: () => Module.canvas.width,
  1742346: () => screen.width,
  1742371: () => {
    document.exitFullscreen();
  },
  1742398: $0 => {
  ...
  1742592: () => window.innerWidth,
  1742618: () => window.innerHeight,
  1742645: () => {
    if (document.fullscreenElement) return 1;
  },
  1742691: () => Module.canvas.width,
  1742723: () => parseInt(Module.canvas.style.width),
  1742771: () => {
    if (document.fullscreenElement) return 1;
  },
  1742817: () => Module.canvas.width,
  1742849: () => screen.width,
  1742874: () => window.innerWidth,
  1742900: () => window.innerHeight,
  1742927: () => {
    if (document.fullscreenElement) return 1;
  },
  1742973: () => Module.canvas.width,
  1743005: () => screen.width,
  1743030: () => {
    document.exitFullscreen();
  },
  1743057: () => {
  ...
  1743103: () => Module.canvas.width,
  1743135: () => parseInt(Module.canvas.style.width),
  1743183: () => {
    document.exitFullscreen();
  },
  1743210: $0 => {
  ...
  1743248: () => screen.width,
  1743273: () => screen.height,
  1743299: () => window.screenX,
  1743326: () => window.screenY,
  1743353: () => window.devicePixelRatio,
  1743389: $0 => {
  ...
  1743930: () => window.innerWidth,
  1743956: () => window.innerHeight,
  1743983: ($0, $1, $2, $3, $4) => {
  ...
  1746465: () => (navigator.mediaDevices !== undefined && navigator.mediaDevices.getUserMedia !== undefined),
  1746569: () => {
    try {
  ...
  1749617: $0 => window.miniaudio.get_device_by_index($0).webaudio.sampleRate,
  1749690: $0 => {
...
function _local_storage_load(key) {
...
function _local_storage_save(key, value) {
  localStorage.setItem(UTF8ToString(key), UTF8ToString(value));
}

function get_hardware_concurrency() {
  if (navigator && navigator.hardwareConcurrency) return navigator.hardwareConcurrency; else return 1;
}
...
function assignWasmImports() {
  wasmImports = {
    /** @export */ GetLastPastedText,
    /** @export */ SetCanvasIdJs,
    /** @export */ __assert_fail: ___assert_fail,
    /** @export */ __asyncjs__RequestClipboardData,
